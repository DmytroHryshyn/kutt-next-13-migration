...
const env = cleanEnv(process.env, {
  ...
  NEXT_PUBLIC_DISALLOW_ANONYMOUS_LINKS: bool({ default: false }),
  NEXT_PUBLIC_DISALLOW_REGISTRATION: bool({ default: false }),
  ...
  MAIL_PASSWORD: str(),
  NEXT_PUBLIC_REPORT_EMAIL: str({ default: "" }),
  NEXT_PUBLIC_CONTACT_EMAIL: str({ default: "" })
});
