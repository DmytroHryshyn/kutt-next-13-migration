...
- **NEXT_PUBLIC_DEFAULT_DOMAIN**: The domain of your kutt instance
...
- **NEXT_PUBLIC_REPORT_EMAIL**: Kutt offers a form to report malicious links which are sent to this mail-address
