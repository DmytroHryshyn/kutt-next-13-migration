export const NEXT_PUBLIC_DISALLOW_ANONYMOUS_LINKS =
  process.env.NEXT_PUBLIC_DISALLOW_ANONYMOUS_LINKS === "true";

export const NEXT_PUBLIC_DISALLOW_REGISTRATION =
  process.env.NEXT_PUBLIC_DISALLOW_REGISTRATION === "true";
